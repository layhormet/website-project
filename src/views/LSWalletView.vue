      ...
      <div class="rank_product">
        ...
        <div class="rank_product_right">
          <div class="rank_product_content">
            <h1>Explore our diverse range <br> of card products</h1>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
            ...
            <div class="product_content_img">
              <img src="@/assets/ls_wallet/product_card.png" alt="Ranked Product" />
            </div>
          </div>
...
.premium_card1, .premium_card2, .premium_card3 {
  position: absolute;
  width: 60%;
  height: 400px;
}
...
.premium_card1 img, .premium_card2 img, .premium_card3 img {
  width: 100%;
  height: 350px;
  border-radius: 20px;
}
